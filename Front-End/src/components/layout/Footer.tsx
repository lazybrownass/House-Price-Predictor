    ...
    <footer className="bg-gray-900 text-gray-300">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          {/* Company Info */}
          <div>
            <h3 className="text-white text-lg font-semibold mb-4">House Predictor</h3>
            <p className="text-sm mb-4">
              Advanced machine learning solutions for accurate house price predictions in the Seattle area.
            </p>
            ...
            <ul className="space-y-4">
              <li className="flex items-center space-x-3">
                ...
                <div>
                  ...
                  <span>support@housepredictor.com</span>
                </div>
              </li>
              <li className="flex items-center space-x-3">
              ...
              <li className="flex items-center space-x-3">
                ...
                <div>
                  ...
                  <span>852-B Milaad Street, Block B,<br />
                  Faisal Town,<br />
        ...
        <div className="border-t border-gray-800 mt-12 pt-8">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <p className="text-sm">
              © {new Date().getFullYear()} House Predictor. All rights reserved.
            </p>
